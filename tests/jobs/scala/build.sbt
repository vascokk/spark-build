...
lazy val root = (project in file("."))
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.airbnb" % "kafka-statsd-metrics2" % "0.5.2+issue28" from "https://dcos-spark-universe.s3.amazonaws.com/scale-tests/kafka-statsd-metrics2-0.5.2+issue28-20180612-8c1e3c4f3fa83.jar",
